...
addTransactionDifferentEDM = async () => {
  try {
    ...
    const cartFastEDM = await page.waitForSelector(
      "xpath//html/body/div/div[2]/div[3]/div[2]/div/div[2]/div/div[11]/div/div[2]/button[2]"
    );
    await cartFastEDM.click();

    const productButton = await page.waitForSelector(
      "xpath//html/body/div/div[2]/div[1]/div[2]/label"
    );
    ...
    setTimeout(async () => {
      const paymentButton = await page.waitForSelector(
        "xpath//html/body/div/div[2]/div[1]/div[5]/div"
      );
...
module.exports = addTransactionDifferentEDM;
